...
public class RawProductData {
    ...
    public void setWithQuantityStructure(String withQuantityStructure) {
        WithQuantityStructure = withQuantityStructure;
    }
    ...
    public String toString() {
        return "RawProductData{" +
                ...
                ", validFromPlantMaterial='" + validFromPlantMaterial + '\'' +
                ...
                ", entry='" + entry + '\'' +
                ", salesUnit='" + salesUnit + '\'' +
                ", deliveryPlantSpecStatus='" + deliveryPlantSpecStatus + '\'' +
                ...
                ", batchManagementPlant='" + batchManagementPlant + '\'' +
                ", transportationGroup='" + transportationGroup + '\'' +
                ", loadingGroup='" + loadingGroup + '\'' +
                ", profitCenter='" + profitCenter + '\'' +
                ", serialNoProfile='" + serialNoProfile + '\'' +
                ", countryOfOrigin='" + countryOfOrigin + '\'' +
                ", plantSpecificMaterialStatus='" + plantSpecificMaterialStatus + '\'' +
                ", validFromCrossPlantMaterial='" + validFromCrossPlantMaterial + '\'' +
                ", goodsReceiptProcessingTime='" + goodsReceiptProcessingTime + '\'' +
                ", mrpGroup='" + mrpGroup + '\'' +
                ", mrpType='" + mrpType + '\'' +
                ...
                ", specialProcurement='" + specialProcurement + '\'' +
                ", productStoreLocation='" + productStoreLocation + '\'' +
                ", inhouseProductionTime='" + inhouseProductionTime + '\'' +
                ", schedulingMarginKey='" + schedulingMarginKey + '\'' +
                ", strategyGroup='" + strategyGroup + '\'' +
                ", consumptionMode='" + consumptionMode + '\'' +
                ", backrwardConsumptionPeriod='" + backrwardConsumptionPeriod + '\'' +
                ", forwardConsumptionPeriod='" + forwardConsumptionPeriod + '\'' +
                ", mixedMRP='" + mixedMRP + '\'' +
                ", individualCollectiveRequirements='" + individualCollectiveRequirements + '\'' +
                ", mrpDependentRequirements='" + mrpDependentRequirements + '\'' +
                ", productionSchedulingProfile='" + productionSchedulingProfile + '\'' +
                ", minimumRemainingShelfLife='" + minimumRemainingShelfLife + '\'' +
                ...
                ", qunatityDenominator='" + qunatityDenominator + '\'' +
                ", aun='" + aun + '\'' +
                ", qunatityNumerator='" + qunatityNumerator + '\'' +
                '}';
    }
